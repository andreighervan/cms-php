<table class="table table-bordered table-hover">
    ...
    while ($row = mysqli_fetch_assoc($select_comments)) {
        ...
        ?>
        <tr>
            <?php echo "<td>$comment_id</td>"; ?>
            <?php echo "<td>$comment_author</td>"; ?>
            <?php echo "<td>$comment_content</td>"; ?>
            <?php echo "<td>$comment_email</td>"; ?>
            <?php echo "<td>$comment_status</td>";?>
            <?php
